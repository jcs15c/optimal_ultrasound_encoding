...
if __name__ == "__main__":
    ...
    im = ad1.imshow( image_model.get_targets( image_datas, image_locs, 'unencoded')[0], cmap='gray', extent=flipped_range, vmin=bf_params['dB_min'], vmax=0 )
    ...
    ad2.imshow( bin_model.get_targets( bin_datas, bin_locs, 'unencoded')[0], cmap='gray', extent=flipped_range, vmin=bf_params['dB_min'], vmax=0 )
    ...
    ad3.imshow( image_model.get_targets( image_datas, image_locs, 'image_contrast')[0], cmap='gray', extent=flipped_range, vmin=bf_params['dB_min'], vmax=0 )
    ...
    ad4.imshow( bin_model.get_targets( bin_datas, bin_locs, 'image_synthetic')[0], cmap='gray', extent=flipped_range, vmin=bf_params['dB_min'], vmax=0 )
